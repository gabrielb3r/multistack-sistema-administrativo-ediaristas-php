            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{old('nome', $servico->nome??'')}}" type="text" required class="form-control" name="nome" id="nome" placeholder="Nome do serviço">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input value="{{old('valor_minimo',$servico->valor_minimo??null)}}" type="text" required class="form-control" name="valor_minimo" id="valor_minimo" data-mask="#.##0,00" data-mask-reverse="true" placeholder="Valor mínimo do serviço">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{old('valor_quarto',$servico->valor_quarto??'')}}" type="text" required class="form-control" name="valor_quarto" id="valor_quarto" data-mask="#.##0,00" data-mask-reverse="true" placeholder="Valor por quarto">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{old('valor_sala',$servico->valor_sala??'')}}" type="text" required class="form-control" name="valor_sala" id="valor_sala" data-mask="#.##0,00" data-mask-reverse="true" placeholder="Valor por sala">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{old('valor_banheiro',$servico->valor_banheiro??'')}}" type="text" required class="form-control" name="valor_banheiro" id="valor_banheiro" data-mask="#.##0,00" data-mask-reverse="true" placeholder="Valor por banheiro">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{old('valor_cozinha',$servico->valor_cozinha??'')}}" type="text" required class="form-control" name="valor_cozinha" id="valor_cozinha" data-mask="#.##0,00" data-mask-reverse="true" placeholder="Valor por cozinha">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{old('valor_quintal',$servico->valor_quintal??'')}}" type="text" required class="form-control" name="valor_quintal" id="valor_quintal" data-mask="#.##0,00" data-mask-reverse="true" placeholder="Valor por quintal">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{old('valor_outros',$servico->valor_outros??'')}}" type="text" required class="form-control" name="valor_outros" id="valor_outros" data-mask="#.##0,00" data-mask-reverse="true" placeholder="Valor por outros">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
